...
import Com.page.object.ContactInfoPage;
import Com.page.object.ContactOrg_popup;
import Com.page.object.Contactpopup;
import Com.page.object.Contactsinfo;
import Com.page.object.CreateNewContacts;
...
public class Tc_003 {
	...
	public static void main(String[] args) throws Throwable {
		...
		contactname.getLastNameEdt().sendKeys(contactname);
	...
	//river.findElement(By.name("submit")).click();
		...
		ContactOrg_popup orgpopup=new ContactOrg_popup();
		orgpopup.searchandSelectforOrg(contact);
	...
	CreateContactinfopage contactsinfo = new CreateContactinfopage(driver);
		//validation
		contactsinfo.checkcontactcreated(contact, "lastName");
